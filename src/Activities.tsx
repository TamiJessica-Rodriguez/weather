...
const App = () => {
  ...
  return (
    <div className="bg-cover bg-center bg-fixed mx-auto p-4 bg-gray-400 gap-2 min-h-screen">
...
//   return (
//     <div
//       className="bg-cover bg-center bg-fixed mx-auto p-4 bg-gray-400 gap-2 h-screen"
